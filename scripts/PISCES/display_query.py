...
def get_defaults():
	...
	select_string = "select ifm.objectid, ifm.default_observation_type, ifm.default_certainty from defs_if_methods as ifm, defs_input_filters as ife where ifm.input_filter = ife.objectid and ife.code = ?"
...
l_layer_name = arcpy.CreateScratchName("mod_records", "", "FeatureClass", local_vars.workspace)
try:
...
params[7].symbology = os.path.join(local_vars.internal_workspace, "mxds", "base", "gen_3.lyr")
